    ...
    <View style={styles.container} >
      ...
      <ScrollView  >      
        ...
        <View style={[styles.doctor, { flexDirection: 'row' }]}>
          ...
          <Text style={{ fontSize: 15, marginLeft: 159, marginTop: 8, color: '#00B5F1' }}>Xem tất cả <Icon2 name="angle-double-right" size={16} color="#00B5F1" /></Text>
        </View>

        <ScrollView showsHorizontalScrollIndicator={false} horizontal style={styles.horizontalScrollContainer2}>
        ...
        <Text style={styles.bannerText}>Mới nhất</Text>
                ...
                <Image
                  style={styles.image}
                  source={{ uri: doctor.logo }}
                />
                <Text style={styles.title3}>
                  {doctor.name}
                </Text>

                <TouchableOpacity style={styles.button} onPress={() => { alert('Scheduling appointment...') }}>
        ...
        <View style={[styles.doctor, { flexDirection: 'row' }]}>
          ...
          <Text style={{ fontSize: 15, marginLeft: 147, marginTop: 8, color: '#00B5F1' }}>Xem tất cả <Icon2 name="angle-double-right" size={16} color="#00B5F1" /></Text>
        </View>

        <ScrollView showsHorizontalScrollIndicator={false} horizontal style={styles.horizontalScrollContainer}>
                {newData.map((news, index) => (
                  <View key={index} style={styles.cardNew}>
                    ...
                    <Text style={styles.cardTitle} numberOfLines={2} ellipsizeMode="tail">{news.name}</Text>
        ...
        <View style={[styles.doctor, { flexDirection: 'row' }]}>
          ...
          <Text style={{ fontSize: 15, marginLeft: 121, marginTop: 8, color: '#00B5F1' }}>Xem tất cả <Icon2 name="angle-double-right" size={16} color="#00B5F1" /></Text>
        </View>
      ...
      <View style={styles.navbar}>
        <View style={styles.navbarItem}>
          <Icon name="home" size={24} color="#2F363D" onPress={() => { navigation.navigate('Trangchu' )}} />
          <Text style={styles.navbarText}>Trang chủ</Text>
        </View>
        <View style={styles.navbarItem}>
          <Icon name="user-plus" size={24} color="#2F363D"  onPress={() => { navigation.navigate('BacSi' )}}/>
      ...
      <Image style={styles.chatIcon} source={{ uri: 'https://cdn.bookingcare.vn/fo/w640/2024/03/27/151956-chatboticon.png' }} />
       ...
       {isNavbarVisible && (
        <>
       <TouchableOpacity style={styles.overlayBackground} onPress={handleOutsidePress}>
         </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.item}>
        <Image
          source={{ uri: 'https://hapotravel.com/wp-content/uploads/2023/04/tong-hop-25-logo-dien-thoai-dep-nhat-nam-2023_26.jpg' }}
      ...
      <TouchableOpacity style={styles.item}>
        <Image
          source={{ uri: 'https://static-00.iconduck.com/assets.00/messenger-icon-1024x1024-wsuio165.png' }}
          style={styles.iconImage}
        />
        <View style={styles.text}>
      ...
      <TouchableOpacity style={styles.item}>
        <Image
          source={{ uri: 'https://giaiphapzalo.com/wp-content/uploads/2021/10/logo-transperant.png' }}
          style={styles.iconImage}
        />
        <View style={styles.text}>
...
const servicesData = [
  { icon: 'https://medpro.vn/_next/image?url=https%3A%2F%2Fprod-partner.s3-hcm-r1.longvan.net%2F488715df-05ff-42ef-bf6b-27d91d132158-bacsi.png&w=128&q=75', label: 'Đặt khám theo bác sĩ' },
  { icon: 'https://medpro.vn/_next/image?url=https%3A%2F%2Fprod-partner.s3-hcm-r1.longvan.net%2F9fdd77eb-9baa-4f3b-a108-d91e136a0bf9-tele.png&w=128&q=75', label: 'Tư vấn trực tuyến' },
  { icon: 'https://medpro.vn/_next/image?url=https%3A%2F%2Fprod-partner.s3-hcm-r1.longvan.net%2Fb4181f19-f965-40b8-a4c5-2996cb960104-goi_kham.png&w=128&q=75', label: 'Gói khám sức khỏe' },
  { icon: 'https://medpro.vn/_next/image?url=https%3A%2F%2Fprod-partner.s3-hcm-r1.longvan.net%2F0640985d-4280-4e8c-8ec6-939f9a4cf44b-thanhtoanvp.png&w=128&q=75', label: 'Thanh toán trực tuyến' },
  { icon: 'https://medpro.vn/_next/image?url=https%3A%2F%2Fcdn-pkh.longvan.net%2Fprod-partner%2Ffa0b00be-d554-404a-bf9a-4a5f216ee978-chaam_saac_taaoa_i_nhaa.png&w=128&q=75', label: 'Y tế tại nhà' },
  { icon: 'https://medpro.vn/_next/image?url=https%3A%2F%2Fcdn.medpro.vn%2Fprod-partner%2Fc193937f-8c0f-479e-be31-5610db6f7df1-dat-lich-xet-nghiem.png&w=128&q=75', label: 'Hướng dẫn đặt khám' },
  { icon: 'https://medpro.vn/_next/image?url=https%3A%2F%2Fcdn-pkh.longvan.net%2Fprod-partner%2Ff141b109-2daa-4953-ad55-5a395f900d46-tiaaam_chaaang.png&w=128&q=75', label: 'Đặt lịch tiêm chủng' },
  { icon: 'https://bookingcare.vn/_next/image?url=https%3A%2F%2Fcdn.bookingcare.vn%2Ffo%2F2023%2F06%2F07%2F161350-iconkham-tong-quan.png&w=128&q=75', label: 'Hướng dẫn đặt khám' },
];
